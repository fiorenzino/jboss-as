...
import org.jboss.as.server.deployment.DeploymentStartHandler;
import org.jboss.as.server.deployment.DeploymentStatusHandler;
import org.jboss.as.server.deployment.DeploymentStopHandler;
...
public class ServerControllerModelUtil {
    ...
    public static void initOperations(final ManagementResourceRegistration root,
        ...
        final DeploymentStartHandler dstarth = new DeploymentStartHandler();
        deployments.registerOperationHandler(DeploymentStartHandler.OPERATION_NAME, dstarth, dstarth, false);
        final DeploymentStopHandler dstoph = new DeploymentStopHandler();
        deployments.registerOperationHandler(DeploymentStopHandler.OPERATION_NAME, dstoph, dstoph, false);
