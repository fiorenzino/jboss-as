 ...
 * @since 04-May-2012
 */
public class StopHandler extends BatchModeCommandHandler {

    private final ArgumentWithValue name;

    public StopHandler(CommandContext ctx) {
        super(ctx, "stop", true);
    ...
    protected void doHandle(CommandContext ctx) throws CommandFormatException {
        ...
        try {
            ...
            throw new CommandFormatException("Stop failed: " + e.getLocalizedMessage());
        }
        if (!Util.isSuccess(result)) {
            throw new CommandFormatException("Stop failed: " + Util.getFailureDescription(result));
        }
    }
